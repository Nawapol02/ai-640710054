# -*- coding: utf-8 -*-
"""my-search-pathfinding.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EtTOuJknd2TEmnpH49UgzarWD9eY3KU4
"""
...
# Define location - เปลี่ยนเป็นนครปฐม
place = "Mueang Nakhon Pathom, Nakhon Pathom, Thailand"
...
plt.title("Road Type Distribution in Nakhon Pathom")
plt.xlabel("Road Type")
plt.ylabel("Count")
plt.tight_layout()
plt.show()

# Define coordinates (lat, lon) - Updated coordinates
origin = (13.814271, 100.037143)      # New origin coordinates
destination = (13.819529, 100.040817)  # New destination coordinates
...
# New destination for comparison - nearby point
alt_destination = (13.820000, 100.045000)
...
# Safe fallback lat/lon - updated to match new area
lat, lon = 13.817000, 100.039000
